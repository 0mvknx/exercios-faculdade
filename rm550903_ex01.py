...
## condição criada, caso a pessoa queira fazer mais de um calculo por vez
...
Código: """)
    ...
    while(tipoAssinatura != '1' and tipoAssinatura != '2' and tipoAssinatura != '3' and tipoAssinatura != '4' and tipoAssinatura != '5') :
